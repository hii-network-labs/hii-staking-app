// StakeHub Contract ABI (simplified for staking operations)
export const STAKEHUB_ABI = [
  {
    "inputs": [
  ...
  },
  {
    "inputs": [
      {"internalType": "address", "name": "validator", "type": "address"},
      {"internalType": "uint256", "name": "requestNumber", "type": "uint256"}
    ],
    "name": "claim",
    "outputs": [],
    "stateMutability": "nonpayable",
  ...
  },
  {
    ...
    "name": "getValidatortotalPooledHIZRecord",
    "outputs": [
      {"internalType": "uint256", "name": "", "type": "uint256"}
    ],
    "stateMutability": "view",
...
export const STAKE_CREDIT_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      {"internalType": "uint256", "name": "hncAmount", "type": "uint256"},
